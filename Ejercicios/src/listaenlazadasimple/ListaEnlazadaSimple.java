...
public class ListaEnlazadaSimple {
    ...
    // ----------------------------------------------------------------------------------------------------------
    // elimina nodo de la cabeza de la lista enlazada simple (asume que la lista
    // enlazada no esta vacia)
    ...
    public void mostrarLista() {
        System.out.print("Lista(primero -> ultimo):"); // recorremos lista enlazada desde el primero hasta el ultimo
                                                       // nodo
    ...
    // -----------------------------------------------------------------------------------------------------------
    // busca nodo con el dato del parametro pasado al metodo (asume una lista
    // enlazada no vacia)
    ...
    // -----------------------------------------------------------------------------------------------------------
    // borra nodo que contiene el objeto dato ingresado como parametro en el metodo
    // (asume una lista enlazada no vacia)
    ...
    // --------------------------------------------------------------------------------------------------------------
    /*
     * inserta nodo con parametro valorNuevo despues del nodo que contiene el valor
     * del parametro valorExistente, metodo retorna el nodo insertado, caso
     * contrario de no poderse insertar nodo retorna null (metodo asume una lista
     * enlazada no vacia)
     */
