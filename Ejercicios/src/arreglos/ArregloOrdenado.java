...
public class ArregloOrdenado {
    ...
    // -------------------------------------------------------------------------------------------------------
    // busqueda binaria. retorna posicion del elemento dato en el arreglo caso
    // contrario retorna -1
    ...
    public void insertar(long dato) {
        ...
        for (j = 0; j < numElems; j++) { // recorre arreglo elemento por elemento
            if (arr[j] > dato) { // elemento en la posicion j es mayor a elemento a insertar
                break; // se detiene bucle. elemento a insertar estara en posicion j
            }
        }

        // desplaza celdas de arreglo una posicion hacia arriba a partir del indice j
        // donde se insertara el elemento
    ...
    // -------------------------------------------------------------------------------------------------------
    // elimina dato de arreglo; retorna false si no se puede eliminar dato porque no
    // exite en arreglo
    public boolean eliminar(long dato) {
        ...
        return true; // se borro elemento dato
    }
